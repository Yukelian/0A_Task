...
/**  根据main.h中配置修改 */
/** ===================== */
#define RF24L01_CE_GPIO_PORT			NRF_CE_GPIO_Port
#define RF24L01_CE_GPIO_PIN				NRF_CE_Pin

#define RF24L01_CS_GPIO_PORT			NRF_CS_GPIO_Port
#define RF24L01_CS_GPIO_PIN				NRF_CS_Pin

#define RF24L01_IRQ_GPIO_PORT			NRF_IRQ_GPIO_Port
#define RF24L01_IRQ_GPIO_PIN			NRF_IRQ_Pin
...
// 接收中断	=====>>>	低电平：收到数据	高电平：默认状态
#define RF24L01_GET_IRQ_STATUS()	HAL_GPIO_ReadPin(RF24L01_IRQ_GPIO_PORT, RF24L01_IRQ_GPIO_PIN)
...
// ========================================== 操作接口定义 ============================================== //
uint8_t NRF24L01_Read_Reg( uint8_t RegAddr );   //NRF24L01读寄存器
